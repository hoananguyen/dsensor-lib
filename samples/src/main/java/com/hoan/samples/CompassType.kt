...
fun getDSensorTypes(context: Context?, compassType: Int?): Int {
    ...
    return when (compassType) {
        ...
        CompassType.TYPE_COMPASS_AND_DEPRECATED_ORIENTATION -> sensorTypes or TYPE_DEPRECATED_ORIENTATION
        CompassType.TYPE_3D_COMPASS -> sensorTypes or TYPE_NEGATIVE_Z_AXIS_DIRECTION
